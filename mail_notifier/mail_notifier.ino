...
#define WIFISSID "XXX" // Put your WifiSSID here
#define PASSWORD "XXX" // Put your wifi password here

char * MakerIFTTT_Event = "your event name";
char * MakerIFTTT_Key = "ifttt-token"; // Webhooks settings key
...
String PostData = "{\"value1\" : \"ESP32 mail test!\" }";
